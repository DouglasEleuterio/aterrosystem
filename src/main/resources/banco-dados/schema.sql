...
CREATE TABLE IF NOT EXISTS AUT_AUTHORITY (
...
CREATE TABLE IF NOT EXISTS USA_USER_AUTHORITY(
    USR_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS TRS_TRANSPORTADOR (
...
CREATE TABLE IF NOT EXISTS TDS_TIPO_DESCARTE (
...
CREATE TABLE IF NOT EXISTS FRP_FORMA_PAGAMENTO (
...
CREATE TABLE IF NOT EXISTS CMB_COMBO (
...
CREATE TABLE IF NOT EXISTS AQS_AQUISICAO (
...
CREATE TABLE IF NOT EXISTS GRD_GERADOR (
...
CREATE TABLE IF NOT EXISTS VCL_VEICULO (
...
CREATE TABLE IF NOT EXISTS DST_DESTINATARIO (
...
CREATE TABLE IF NOT EXISTS MTR_MOTORISTA (
...
CREATE TABLE IF NOT EXISTS CTR_CTR (
...
CREATE TABLE IF NOT EXISTS CTT_CTR_TIPO_DESCARTE (
    CTR_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS PGT_PAGAMENTO (
...
CREATE TABLE IF NOT EXISTS DSC_DESCARTE_POR_COMBO (
